...
class Patient(models.Model):    
    ...
    allergies = models.ManyToManyField(AllergySubstance, through='PatientAllergy', related_name='patients', blank=True)
    cancer = models.ManyToManyField(CancerType, through='PatientCancer', related_name='patients', blank=True)
